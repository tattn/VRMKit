...
class VRM1Tests: XCTestCase {
    ...
    func testSpringBone() {
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.offset[0].getValue(), -0.04)
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.offset[1].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.offset[2].getValue(), 0.02)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.tail[0].getValue(), 0.04)
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.tail[1].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.colliders?[0].shape.capsule?.tail[2].getValue(), 0.02)
        
        XCTAssertEqual(vrm.springBone?.colliders?[1].node, 5)
        XCTAssertEqual(vrm.springBone?.colliders?[1].shape.sphere?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[1].shape.sphere?.offset[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.colliders?[1].shape.sphere?.offset[1].getValue(), 0.02)
        XCTAssertEqual(vrm.springBone?.colliders?[1].shape.sphere?.offset[2].getValue(), -0.07)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.offset[0].getValue(), 0.065)
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.offset[1].getValue(), 0.14)
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.offset[2].getValue(), 0.01)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.tail[0].getValue(), -0.065)
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.tail[1].getValue(), 0.14)
        XCTAssertEqual(vrm.springBone?.colliders?[2].shape.capsule?.tail[2].getValue(), 0.01)
        
        XCTAssertEqual(vrm.springBone?.colliders?[3].node, 5)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.offset[0].getValue(), 0.04)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.offset[1].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.offset[2].getValue(), 0.02)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.tail[0].getValue(), -0.04)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.tail[1].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.colliders?[3].shape.capsule?.tail[2].getValue(), 0.02)
        
        XCTAssertEqual(vrm.springBone?.colliders?[4].node, 130)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.offset[0].getValue(), -0.004536999)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.offset[1].getValue(), 7.566095e-9)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.offset[2].getValue(), 0.0127928918)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.tail[0].getValue(), -0.001991607)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.tail[1].getValue(), 0.329534262)
        XCTAssertEqual(vrm.springBone?.colliders?[4].shape.capsule?.tail[2].getValue(), 0.009325488)
        
        XCTAssertEqual(vrm.springBone?.colliders?[5].node, 131)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.offset[0].getValue(), 4.570225e-9)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.offset[1].getValue(), -1.477034e-8)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.offset[2].getValue(), 0.008859742)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.tail[0].getValue(), 2.013798e-8)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.tail[1].getValue(), 0.3535266)
        XCTAssertEqual(vrm.springBone?.colliders?[5].shape.capsule?.tail[2].getValue(), 0.008811156)
        
        XCTAssertEqual(vrm.springBone?.colliders?[6].node, 137)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.offset[0].getValue(), 0.004536999)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.offset[1].getValue(), 7.566095e-9)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.offset[2].getValue(), 0.0127928918)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.tail[0].getValue(), 0.001991607)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.tail[1].getValue(), 0.329534262)
        XCTAssertEqual(vrm.springBone?.colliders?[6].shape.capsule?.tail[2].getValue(), 0.009325488)
        
        XCTAssertEqual(vrm.springBone?.colliders?[7].node, 138)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.offset.count, 3)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.offset[0].getValue(), -4.57022464e-9)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.offset[1].getValue(), -1.477034e-8)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.offset[2].getValue(), 0.008859742)
        ...
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.tail[0].getValue(), -2.013798e-8)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.tail[1].getValue(), 0.3535266)
        XCTAssertEqual(vrm.springBone?.colliders?[7].shape.capsule?.tail[2].getValue(), 0.008811156)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].node, 75)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[0].stiffness.getValue(), 4)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].node, 76)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[1].stiffness.getValue(), 4)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].node, 77)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[2].stiffness.getValue(), 3)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].node, 78)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[3].stiffness.getValue(), 3)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].node, 79)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[4].stiffness.getValue(), 2)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].node, 80)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[5].stiffness.getValue(), 2)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].node, 81)
        XCTAssertEqual(vrm.springBone?.springs?[0].joints[6].stiffness.getValue(), 2)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].node, 47)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[0].stiffness.getValue(), 1.2)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].node, 48)
        XCTAssertEqual(vrm.springBone?.springs?[1].joints[1].stiffness.getValue(), 1.2)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].node, 50)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[0].stiffness.getValue(), 1.2)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].node, 51)
        XCTAssertEqual(vrm.springBone?.springs?[2].joints[1].stiffness.getValue(), 1.2)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].node, 53)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[0].stiffness.getValue(), 1.2)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].node, 54)
        XCTAssertEqual(vrm.springBone?.springs?[3].joints[1].stiffness.getValue(), 1.2)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].node, 56)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[0].stiffness.getValue(), 1.2)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].node, 57)
        XCTAssertEqual(vrm.springBone?.springs?[4].joints[1].stiffness.getValue(), 1.2)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].node, 59)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[0].stiffness.getValue(), 1.2)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].node, 60)
        XCTAssertEqual(vrm.springBone?.springs?[5].joints[1].stiffness.getValue(), 1.2)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].node, 62)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[0].stiffness.getValue(), 1.2)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].node, 63)
        XCTAssertEqual(vrm.springBone?.springs?[6].joints[1].stiffness.getValue(), 1.2)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].node, 65)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[0].stiffness.getValue(), 1.2)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].hitRadius, 0.01)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].node, 66)
        XCTAssertEqual(vrm.springBone?.springs?[7].joints[1].stiffness.getValue(), 1.2)
        ...
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].node, 37)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[0].stiffness.getValue(), 4)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].node, 38)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[1].stiffness.getValue(), 4)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].node, 39)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[2].stiffness.getValue(), 4)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].node, 40)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[3].stiffness.getValue(), 4)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].node, 41)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[4].stiffness.getValue(), 4)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].hitRadius, 0.06)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].node, 42)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[5].stiffness.getValue(), 4)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].dragForce.getValue(), 1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].gravityDir.count, 3)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].gravityDir[0].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].gravityDir[1].getValue(), -1)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].gravityDir[2].getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].gravityPower.getValue(), 0)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].hitRadius, 0.02)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].node, 43)
        XCTAssertEqual(vrm.springBone?.springs?[8].joints[6].stiffness.getValue(), 4)
